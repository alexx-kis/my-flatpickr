...
!(function (e, n) {
  ...
  function m(e, n) {
    var t = d("div", "flatpickr__number-wrapper"),
      a = d("input", "flatpickr__number-input " + e),
      i = d("div", "arrow _up"),
      o = d("div", "arrow _down");
  ...
  function k(p, v) {
    ...
    function H(e) {
      var n = g(e);
      ~n.className.indexOf("arrow") && L(e, n.classList.contains("arrow, _up") ? 1 : -1);
    }
    function L(e, n, t) {
      var a = e && g(e),
    ...
    function R(e, n, t, a) {
      ...
      return (
        ...
        i
          ? ((o.tabIndex = -1),
            be(n) &&
            (o.classList.add("_selected"),
              (w.selectedDateElem = o),
              "range" === w.config.mode &&
              (s(o, "startRange", w.selectedDates[0] && 0 === M(n, w.selectedDates[0], !0)), s(o, "endRange", w.selectedDates[1] && 0 === M(n, w.selectedDates[1], !0)), "_not-current-month" === e && o.classList.add("inRange"))))
        ...
        w.weekNumbers && 1 === w.config.showMonths && "_not-current-month" !== e && a % 7 == 6 && w.weekNumbers.insertAdjacentHTML("beforeend", "<div class='flatpickr__week'>" + w.config.getWeek(n) + "</div>"),
        De("onDayCreate", o),
        o
      );
    }
    ...
    function K(e, n) {
      for (
        ...
        l = r ? "_not-current-month hidden" : "_not-current-month",
        c = r ? "_not-current-month hidden" : "_not-current-month",
        s = a + 1 - t,
        u = 0;
        s <= a;
        s++, u++
      )
        o.appendChild(R("flatpickr__day " + l, new Date(e, n - 1, s), 0, u));
      for (s = 1; s <= i; s++, u++) o.appendChild(R("flatpickr__day", new Date(e, n, s), 0, u));
      for (var f = i + 1; f <= 42 - t && (1 === w.config.showMonths || u % 7 != 0); f++, u++) o.appendChild(R("flatpickr__day " + c, new Date(e, n + 1, f % i), 0, u));
      var m = d("div", "flatpickr__days-inner");
    ...
    function q() {
      if (!(w.config.showMonths > 1 || "dropdown" !== w.config.monthSelectorType)) {
        ...
        for (var n = 0; n < 12; n++)
          if (e(n)) {
            var t = d("option", "flatpickr__month-option");
    ...
    function $() {
      var e,
        n = d("div", "flatpickr__header-inner"),
        t = window.document.createDocumentFragment();
      w.config.showMonths > 1 || "static" === w.config.monthSelectorType
        ? (e = d("div", "cur-month"))
        : ((w.monthsDropdownContainer = d("select", "flatpickr__month-select")),
      ...
      var a = m("flatpickr__year", { tabindex: "-1" }),
    ...
    function z() {
      w.weekdayContainer ? u(w.weekdayContainer) : (w.weekdayContainer = d("div", "flatpickr__weekdays"));
      for (var e = w.config.showMonths; e--;) {
        var n = d("div", "flatpickr__weekdays-inner");
    ...
    function G() {
      if (w.weekdayContainer) {
        ...
        for (var a = w.config.showMonths; a--;) w.weekdayContainer.children[a].innerHTML = "\n      <div class='flatpickr__weekday'>\n        " + t.join("</div><div class='flatpickr__weekday'>") + "\n      </div>\n      ";
      }
    }
    function Z(e, n) {
      void 0 === n && (n = !0);
    ...
    function te(e) {
      return void 0 !== w.daysContainer && -1 === e.className.indexOf("hidden") && -1 === e.className.indexOf("_disabled") && w.daysContainer.contains(e);
    }
    function ae(e) {
    ...
    function oe(e, n) {
      if ((void 0 === n && (n = "flatpickr__day"), 1 === w.selectedDates.length && (!e || (e.classList.contains(n) && !e.classList.contains("_disabled"))))) {
        for (
              ...
              if (((w.calendarContainer.style.top = u + "px"), h))
                if (v) {
                  ...
                  s(w.calendarContainer, "rightMost", !1),
                    ...
                    D.insertRule(".flatpickr.centerMost:before,.flatpickr.centerMost:after" + y, M),
    ...
    function me(e) {
      ...
      var n = f(g(e), function (e) {
        return e.classList && e.classList.contains("flatpickr__day") && !e.classList.contains("_disabled") && !e.classList.contains("notAllowed");
      });
      if (void 0 !== n) {
        var t = n,
    ...
    (w.parseDate = C({ config: w.config, l10n: w.l10n })),
      ...
      (w.destroy = function () {
        ...
        w.input && ((w.input.type = w.input._type), w.input.classList.remove("flatpickr__input"), w.input.removeAttribute("readonly"));
        [
          "_showTimeInput",
    ...
    function xe(e) {
      ...
      t || a ? Z(t ? -1 : 1) : w.yearElements.indexOf(n) >= 0 ? n.select() : n.classList.contains("_up")  ? w.changeYear(w.currentYear + 1) : n.classList.contains("_down") && w.changeYear(w.currentYear - 1);
    }
    return (
      (function () {
        (w.element = w.input = p),
          ...
          (function () {
            ...
            (w.input._type = w.input.type),
              (w.input.type = "text"),
              w.input.classList.add("flatpickr__input"),
              (w._input = w.input),
              w.config.altInput &&
          ...
          (function () {
            ...
            if (((w.calendarContainer = d("div", "flatpickr")), (w.calendarContainer.tabIndex = -1), !w.config.noCalendar)) {
              if (
                (e.appendChild(
                  ((w.monthNav = d("div", "flatpickr__header")),
                    (w.yearElements = []),
                    (w.monthElements = []),
                    (w.prevMonthNav = d("div", "flatpickr__header-arrow _prev")),
                    (w.prevMonthNav.innerHTML = w.config.prevArrow),
                    (w.nextMonthNav = d("div", "flatpickr__header-arrow _next")),
                    ...
                    Object.defineProperty(w, "_hidePrevMonthArrow", {
                      ...
                      set: function (e) {
                        w.__hidePrevMonthArrow !== e && (s(w.prevMonthNav, "_disabled", e), (w.__hidePrevMonthArrow = e));
                      },
                    }),
                    Object.defineProperty(w, "_hideNextMonthArrow", {
                      ...
                      set: function (e) {
                        w.__hideNextMonthArrow !== e && (s(w.nextMonthNav, "_disabled", e), (w.__hideNextMonthArrow = e));
                      },
                    }),
                  ...
                  (w.innerContainer = d("div", "flatpickr__body")),
                  w.config.weekNumbers)
              ) {
                var n = (function () {
                  w.calendarContainer.classList.add("hasWeeks");
                  var e = d("div", "flatpickr__weeks");
                  e.appendChild(d("div", "flatpickr__weekday", w.l10n.weekAbbreviation));
                  var n = d("div", "flatpickr__weeks-inner");
              ...
              (w.rContainer = d("div", "flatpickr__body-inner")),
                w.rContainer.appendChild(z()),
                w.daysContainer || ((w.daysContainer = d("div", "flatpickr__days")), (w.daysContainer.tabIndex = -1)),
                U(),
            ...
            w.config.enableTime &&
              e.appendChild(
                (function () {
                  ...
                  var e = E(w.config);
                  (w.timeContainer = d("div", "flatpickr__time")), (w.timeContainer.tabIndex = -1);
                  var n = d("div", "flatpickr__time-separator", ":"),
                  ...
                  if (w.config.enableSeconds) {
                    ...
                    (w.secondElement = i.getElementsByTagName("input")[0]),
                      ...
                      w.timeContainer.appendChild(d("div", "flatpickr__time-separator", ":")),
                      w.timeContainer.appendChild(i);
                  }
                  w.config.time_24hr ||
                    ((w.amPM = d("div", "flatpickr__meridiem", w.l10n.amPM[r((w.latestSelectedDateObj ? w.hourElement.value : w.config.defaultHour) > 11)])),
